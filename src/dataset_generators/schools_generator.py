...
def main():
    ...
    infanzia = json.load(open(os.path.join(os.path.dirname(os.path.abspath(__file__)), '../..', 'Datasets/Scuole/scuoleinfanzia_2012_2013.geojson')))
    elementari = json.load(open(os.path.join(os.path.dirname(os.path.abspath(__file__)), '../..', 'Datasets/Scuole/scuoleprimarie_2012_2013.geojson')))
    medie = json.load(open(os.path.join(os.path.dirname(os.path.abspath(__file__)), '../..', 'Datasets/Scuole/scuolesecondarie1grado_2012_2013.geojson')))
    superiori = json.load(open(os.path.join(os.path.dirname(os.path.abspath(__file__)), '../..', 'Datasets/Scuole/scuolesecondariesecondogrado.geojson')))
